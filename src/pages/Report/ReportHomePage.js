...
const ReportHomePage = ({navigation}) =>{
        ...
        <SafeAreaView style={styles.mainView}>
            <View style={styles.bodyView}>
                <Button mode="contained"
                        ...
                        onPress={() => navigation.navigate('Report Add Friends')}>
                    <Text>
                        Add Contacts
                    </Text>
                </Button>
                                    ...
                                    <View key={ind} style={{
                                        ...
                                        <View style={{flexDirection: 'row', flexGrow: 1, padding:10, width:'80%'}}>
                                            ...
                                            <TouchableOpacity onPress={()=> {
                                                console.log("Pressed")
                                                navigation.navigate("Report Today", {
                                                    id: val.id,
                                                    name: val.name
                                                })
                                            }}>
                                                <Text style={{color:'#fff', fontSize: 18, fontWeight:'bold'}}>{val.name}</Text>
                                                <Text style={{color:'#fff', fontSize: 18, fontWeight:'bold'}}>{val.email}</Text>
                                            </TouchableOpacity>
                                        </View>
